...
=== H_W_03 ===
Nie pamiętasz tego?<n>To oznacza że stan świata jest gorszy niż zakładały obliczenia.
...
Wracając do Ciebie... Wedle dostępnych informacji danych, Jesteś najlepszym mechanikiem.<n>Właśnie dlatego zostałeś tutaj ściągnięty.
...
=== H_W_04 ===
Wykryte zostały liczne usterki. <n>Doprowadziły one do spadku mocy obliczeniowej i wielu krytycznych funkcji.<n>Uniemożliwiło to podjęcie automatycznej naprawy.
